    ...
    <section id="shop" className="py-32 bg-black relative z-10 px-6 md:px-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-20 text-center">
          <Link
            href="/shop"
            className="inline-flex px-10 py-4 rounded-full border border-neutral-800 text-[11px] uppercase tracking-[0.35em] font-semibold text-neutral-400 hover:text-white hover:border-brand-sky hover:bg-neutral-950/60 transition-all duration-300"
            data-magnetic
          >
            Explore All Items
          </Link>
