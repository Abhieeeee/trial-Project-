      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-0 right-0 z-[9995] w-full sm:w-[440px] h-full bg-neutral-950 border-l border-white/10 shadow-2xl flex flex-col justify-between font-sans overflow-hidden"
          >
            {/* Header Bar */}
            <div className="p-6 border-b border-white/10 bg-black/40 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="p-2 border border-red-500/30 bg-red-500/10 text-red-500">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4 font-mono text-[11px] scrollbar-thin scrollbar-thumb-neutral-800">
              {items.length === 0 ? (
                <div className="h-full flex flex-col items-center justify-center text-center space-y-4 py-12">
                  <Heart className="w-12 h-12 text-neutral-700 animate-pulse" />
                  ...
                  <p className="text-[9px] text-neutral-500 uppercase tracking-widest max-w-xs">
                    Click the heart icon on any apparel item to save it for later.
                  </p>
                  <Link
                    href="/shop"
                    onClick={closeWishlist}
                    className="mt-4 px-6 py-3 bg-white text-black font-bold uppercase tracking-[0.2em] text-[9px] hover:bg-[#00d2ff] transition-colors"
                  >
                    Explore Catalog
                  </Link>
                </div>
                    ...
                    <div className="flex-1 min-w-0 space-y-1">
                      ...
                      <div className="flex items-center gap-2 pt-2">
                        <button
                          ...
                          className="px-3 py-1.5 bg-[#00d2ff] hover:bg-cyan-400 text-black text-[9px] uppercase tracking-wider font-bold transition-colors cursor-pointer flex items-center gap-1.5"
                        >
            ...
            {items.length > 0 && (
              <div className="p-6 border-t border-white/10 bg-neutral-950">
                <Link
                  href="/shop"
                  onClick={closeWishlist}
                  className="w-full py-3.5 text-center bg-white hover:bg-neutral-200 text-black font-bold uppercase tracking-widest text-[9px] flex items-center justify-center gap-2 font-mono"
                >
