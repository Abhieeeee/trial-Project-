        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-8">
            ...
            >
              {specs.map(({ code, label, detail }) => (
                ...
                >
                  <span className="text-[8px] uppercase tracking-[0.3em] text-[#00D2FF] font-mono font-bold">{code}</span>
          ...
          <div className="lg:col-span-4 flex flex-col gap-10">
            <motion.div
              ...
              className="p-8 rounded-2xl glass-panel-glow border border-white/[0.09] bg-[#0a0a0e]/90 flex flex-col gap-6 backdrop-blur-2xl shadow-[0_20px_50px_rgba(0,0,0,0.95)]"
            >
              ...
              <p className="text-xs text-neutral-500 tracking-wide leading-[1.8] font-mono">
            ...
            <div className="flex items-center gap-6 self-start pl-2">
              <div className="relative w-18 h-18 rounded-full border border-white/12 flex items-center justify-center pointer-events-none select-none bg-black/50 shadow-[0_0_30px_rgba(0,0,0,0.8)]">
                <svg className="w-14 h-14 animate-[spin_14s_linear_infinite]" viewBox="0 0 100 100">
                  <path
                    id="circlePath"
              ...
              <div className="flex flex-col font-mono">
                ...
                <span className="text-[8px] uppercase tracking-[0.2em] text-neutral-600 font-mono mt-1.5">
                  Paris, France
                </span>
              </div>
            </div>
