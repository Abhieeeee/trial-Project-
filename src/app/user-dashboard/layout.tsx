...
import { LayoutDashboard, ShoppingBag, LogOut, Menu, X, User, ArrowLeft } from "lucide-react";
...
export default function UserLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-white flex overflow-hidden relative">
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-white/[0.005] rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="p-4 border-t border-neutral-900/60 bg-neutral-950/40">
          <div className="flex items-center gap-3 px-4 py-3 mb-4 rounded-xl bg-white/[0.01] border border-white/5">
            ...
            <div>
              ...
              <div className="text-[8px] uppercase tracking-widest text-neutral-500 font-bold">Basic Access</div>
            </div>
          </div>
